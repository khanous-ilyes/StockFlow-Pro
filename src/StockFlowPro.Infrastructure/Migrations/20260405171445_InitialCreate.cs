    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfflineLicenses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<int>(type: "integer", nullable: false),
                    OrderExpenses = table.Column<decimal>(type: "numeric", nullable: false),
                    Notes = table.Column<string>(type: "text", nullable: true),
                    PaymentMethod = table.Column<int>(type: "integer", nullable: false),
                    AmountPaid = table.Column<decimal>(type: "numeric", nullable: false),
                    RemainingCredit = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClientPayments_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ClientPayments_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Tenants",
                columns: new[] { "Id", "Address", "AllowedMacAddress", "Art", "CreatedAt", "Currency", "DefaultLanguage", "DefaultTaxRate", "IsActive", "LogoUrl", "Mode", "Name", "Nif", "Nis", "PhoneNumber", "Rc", "Slug", "TaxNumber" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), null, null, null, new DateTime(2026, 4, 5, 17, 14, 45, 44, DateTimeKind.Utc).AddTicks(3555), 0, 0, 19.0m, true, null, 1, "Super Admin System", null, null, null, null, "superadmin-system", null });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FullName", "IsActive", "PasswordHash", "Role", "TenantId" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000002"), new DateTime(2026, 4, 5, 17, 14, 45, 44, DateTimeKind.Utc).AddTicks(3642), "superadmin@stockflowpro.dz", "Super Administrator", true, "$2a$12$oAK74cPozcXxkNxH4Zr6ZurKuWp.neYIdudN7aVUWqeSEeNIoqI9e", 0, new Guid("00000000-0000-0000-0000-000000000001") });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientPayments_InvoiceId",
                table: "ClientPayments",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientPayments_TenantId",
                table: "ClientPayments",
                column: "TenantId");
